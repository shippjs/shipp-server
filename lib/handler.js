...
function cache(method, id, contents, renderer) {
  ...
  global.shipp.infograph.addNode(`cache:${key}`, "cache", function() {
    Cache.cool(id, method)
  })

  global.shipp.infograph.addEdge(`renderer:${renderer.id}`, `cache:${key}`)

  // TODO: What to do when the renderer is deleted?
  // TODO: Parse data and bind to firebase stores
  // TODO: Don't readd nodes
