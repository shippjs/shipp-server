...
module.exports = function(options) {
  ...
  global.shipp.cacheControl = "undefined" === typeof(global.shipp.config.cacheControl) ? 1000 * 60 * 60 * 24 : global.shipp.config.cacheControl;
  ...
  global.shipp.debug("Attaching database");
  ...
  // Pipelines
  global.shipp.debug("Attaching pipelines");
