...
module.exports = function(options) {
  ...
  // Information graph
  global.shipp.infograph = new InfoGraph();
  ...
  global.shipp.compilers = require("./compilers")
  if (global.shipp.config.compilers) {
    const userCompilers = require(Utils.makePathAbsolute(global.shipp.config.compilers))
    global.shipp.compilers.addCompilers(userCompilers)
  }
